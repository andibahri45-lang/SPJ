...
const fileContent = `import React, { useState, useMemo, useEffect } from 'react';
import { 
...
export function DataRekapBelanjaForm({
  rekapBelanjaList,
  pesananList,
  subKegiatanList = [],
  rekananList = [],
...
fs.writeFileSync('src/components/DataRekapBelanjaForm.tsx', fileContent, 'utf-8');
console.log("Rewritten DataRekapBelanjaForm");
